defmodule NeuroScav.PromEx do
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :neuro_scav, NeuroScav.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule NeuroScavWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :neuro_scav

       ...

       plug PromEx.Plug, prom_ex_module: NeuroScav.PromEx
  ...
  def dashboards do
    [
      ...
      # {:neuro_scav, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
