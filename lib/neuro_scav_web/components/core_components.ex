defmodule NeuroScavWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NeuroScavWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NeuroScavWeb.Gettext, "errors", msg, opts)
    end
  end
